...
namespace Hairhub.Service.Services.IServices
{
    ...
    {
        Task<IPaginate<GetCustomerResponse>> GetCustomers(string? email, bool? status, string? customerName, bool? isAscendingBooking, string? customertype, int page, int size);
