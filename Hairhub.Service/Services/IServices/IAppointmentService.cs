...
namespace Hairhub.Service.Services.IServices
{
    public interface IAppointmentService
    {
        ...
        Task<IPaginate<GetAppointmentResponse>> GetAppointmentCustomerByStatus(Guid customerId, string? status, int page, int size);
        ...
        Task<IPaginate<GetAppointmentResponse>> GetAppointmentSalonByStatus(int page, int size, Guid SalonId, string? Status, bool isAscending, DateTime? date);
